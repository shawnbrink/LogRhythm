...
(function($) {
    ...
    $.fn.editable = function(event, callback) {
        ...
        edit.start = function(e) {
            ...
            input.val(old_value).css("width", type === "textarea" ? "100%" : target.width() + target.height()).css("font-size", "100%").css("margin", 0).attr("id", "editable_" + new Date * 1).addClass("editable");
